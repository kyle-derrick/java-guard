...
pub trait JvmLauncherHelper<'local> {
    fn from_env<'local>(env: &mut AttachGuard<'local>) -> jni::errors::Result<Self<'local>>;
...
impl<'local> JvmLauncherHelper<'local> for SunLauncherHelper<'local> {
    fn from_env<'local>(env: &mut AttachGuard<'local>) -> jni::errors::Result<SunLauncherHelper<'local>> {
...
impl<'local> JvmLauncherHelper<'local> for SimpleLauncherHelper<'local> {
    fn from_env<'local>(env: &mut AttachGuard<'local>) -> jni::errors::Result<SimpleLauncherHelper<'local>> {
